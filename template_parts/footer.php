        ...
        <div class="row">
            ...
            <div class="col-md-3 col-xs-12 clearfix margin-bottom">
                ...
                <ul class="footer-quick-links-5 text-white">
                    <li class="text-white"><a href="index.php" class="text-white"> Strona Główna</a></li>
                    <li class="text-white"><a href="page-about3.php" class="text-white"> O Nas</a></li>
                    <li class="text-white"><a href="page-coming-soon.php" class="text-white"> Produkty </a></li>
                    <li class="text-white"><a href="contact.php" class="text-white"> Kontakt</a></li>
                    <li class="text-white"><a href="page-coming-soon.php" class="text-white"> Sklep</a></li>
                </ul>
            </div>
            <!--end item-->
            ...
            <div class="col-md-3 col-xs-12 clearfix margin-bottom">
                ...
                <br />
                <ul class="footer-quick-links-5 text-white">
                    <li class="text-white"><a href="page-coming-soon.php" class="text-white"> Produkt 1</a></li>
                    <li class="text-white"><a href="page-coming-soon.php" class="text-white"> Produkt 2</a></li>
                    <li class="text-white"><a href="page-coming-soon.php" class="text-white"> Produkt 3</a></li>
                    <li class="text-white"><a href="page-coming-soon.php" class="text-white"> Produkt 4</a></li>
                    <li class="text-white"><a href="page-coming-soon.php" class="text-white"> Produkt 5</a></li>
                </ul>
            </div>
            <!--end item-->
...
<div class="sec-padding-6 section-footer">
    <div class="container">
        <div class="row">
